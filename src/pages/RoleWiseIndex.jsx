...
export const RoleWiseIndex = ({ onNavigate }) => {
  const [search, setSearch] = useState('');
  const roles = roleWiseData.list || [];
    ...
    <div className="max-w-7xl mx-auto px-2 sm:px-6 py-4 sm:py-8 flex flex-col gap-6 sm:gap-10 w-full">
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 font-sans leading-relaxed">
          Frontend, Backend, DevOps, AI, Mobile, Security — dive into targeted question banks tailored for your exact interview domain.
        </p>
        ...
        <div className="relative max-w-md mx-auto mt-8">
          ...
          <input
            ...
            placeholder="Search role (e.g. Frontend, DevOps, AI, Cloud)..."
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
        {filtered.map((role) => (
          <div
            key={role.slug}
            onClick={() => onNavigate(`/preparation/role-wise/${role.slug}`)}
          ...
          >
            <div>
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 line-clamp-2">
                Core questions, concepts, and technical scenarios for {role.name}.
              </p>
            </div>

            <div className="mt-5 pt-3 border-t border-zinc-100 dark:border-zinc-800/80 flex items-center justify-between text-xs">
              <span className="text-zinc-400 text-[11px]">Ready to study</span>
